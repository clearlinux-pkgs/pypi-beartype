...
Source0  : https://github.com/beartype/beartype/archive/v0.20.0/beartype-0.20.0.tar.gz
...
%prep
%setup -q -n beartype-0.20.0
cd %{_builddir}/beartype-0.20.0
pushd ..
cp -a beartype-0.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740424920
