...
Version  : 0.17.0
Release  : 11
URL      : https://github.com/beartype/beartype/archive/v0.17.0/beartype-0.17.0.tar.gz
Source0  : https://github.com/beartype/beartype/archive/v0.17.0/beartype-0.17.0.tar.gz
...
%prep
%setup -q -n beartype-0.17.0
cd %{_builddir}/beartype-0.17.0
pushd ..
cp -a beartype-0.17.0 buildavx2
popd
pushd ..
cp -a beartype-0.17.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707112409
