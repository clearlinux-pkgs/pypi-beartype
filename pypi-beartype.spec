...
Version  : 0.21.0
Release  : 25
URL      : https://github.com/beartype/beartype/archive/v0.21.0/beartype-0.21.0.tar.gz
Source0  : https://github.com/beartype/beartype/archive/v0.21.0/beartype-0.21.0.tar.gz
...
%prep
%setup -q -n beartype-0.21.0
cd %{_builddir}/beartype-0.21.0
pushd ..
cp -a beartype-0.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747923055
