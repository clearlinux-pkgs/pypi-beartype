...
Source0  : https://github.com/beartype/beartype/archive/v0.16.3/beartype-0.16.3.tar.gz
...
%prep
%setup -q -n beartype-0.16.3
cd %{_builddir}/beartype-0.16.3
pushd ..
cp -a beartype-0.16.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697469903
