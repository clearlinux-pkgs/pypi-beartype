...
Source0  : https://github.com/beartype/beartype/archive/v0.18.3/beartype-0.18.3.tar.gz
...
%prep
%setup -q -n beartype-0.18.3
cd %{_builddir}/beartype-0.18.3
pushd ..
cp -a beartype-0.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713456491
